...
PROMPT = (
    ...
    "1) Run: python3 glance/skills/mit/scripts/today_brief.py\n"
    ...
    "     python3 glance/skills/mit/scripts/log.py --upsert --date <today> --task \"<today task>\" --completed <true|false>\n"
    "     python3 glance/skills/mit/scripts/log.py --upsert --date <tomorrow> --task \"<tomorrow task>\" --completed false\n"
